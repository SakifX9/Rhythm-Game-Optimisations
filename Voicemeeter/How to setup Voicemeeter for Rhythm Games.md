...
USB Audio devices that do not have ASIO drivers may be able to work but they can be inconsitent with latencyI have tried a few Amazon and eBay USB Sound Cards, some worked fine while others had a bit of a noticable delay.
